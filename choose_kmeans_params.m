...
% Last Modified by GUIDE v2.5 08-Jul-2015 11:03:18
...
handles.output = [];
handles.output.num_reps=10;
handles.output.num_clust=4;
handles.output.dist='sqeuclidean';
...
switch val
    case 1
        handles.output.dist='sqeuclidean';
    case 2
        handles.output.dist='cityblock';
    case 3
        handles.output.dist='correlation';
end
guidata(hObject,handles);
...
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
 ...
 set(hObject,'String',{'Euclidean','Manhattan','Correlation'});
